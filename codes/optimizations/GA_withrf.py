...
variable_ranges = [(0, 8), (0,8), (0,8), (0,8), (0,100), (0,100), (0,100), (0,100)] 
epsilon = [0.05, 0.05, 0.05, 0.05, 5., 5., 5., 5.]
learning_rates = np.array([1., 1., 1., 1., 1000., 1000., 1000., 1000.])
n_startpoints = 20
max_iter = 350
tolerance = 1e-6
beta1=0.9
...
def nmr_signal(x):
  for i in range(x.shape[0]):
    if (x[i]<0):
      x[i]=0
    replacement(var_lines[i], var_baselines[i] + str(x[i]*1000 if i==x.shape[0]-1 else x[i]))
